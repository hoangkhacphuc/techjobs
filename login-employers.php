					...
					<div class="col-md-6 col-sm-12 col-12 login-main-right">
						...
						<form class="login-form reg-form">
						  ...
						  <div class="form-group d-block frm-text">
						    ...
						    <a href="./register-employers.php" class="fg-login float-right d-inline-block">Bạn chưa có tài khoản? Đăng Ký</a>
						  </div>
						  <button type="button" id="btn-login-employers" class="btn btn-primary float-right btn-login d-block w-100">Đăng Nhập Nhà Tuyển Dụng</button>

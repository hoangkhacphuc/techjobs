					...
					<div class="col-md-6 col-sm-12 col-12 login-main-right">
						...
						<div class="input-div one">
		           		   <div class="div lg-lable">
		           		   		...
		           		   		<input type="text" class="input form-control-lgin" id="inp-fullname">
		           		   </div>
		           		</div>
						  <div class="input-div one">
		           		   <div class="div lg-lable">
		            	...
		            	<div class="input-div one">
						  ...
						  <div class="form-group d-block frm-text">
						    ...
						    <a href="./login-employees.php" class="fg-login float-right d-inline-block">Bạn đã có tài khoản? Đăng Nhập</a>
						  </div>
						  <button type="button" id="btn-register-employees" class="btn btn-primary float-right btn-login d-block w-100">Đăng Ký</button>

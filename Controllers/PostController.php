<?php
    class PostController {
        // - Hiển thị danh sách các tin tức ở trang NTD
        function Index()
        {
            if(!isset($_SESSION)) 
            { 
        ...
        // - Chỉnh sửa tin tức ở trang NTD (Fixed OK)
        ...
        // - Xem chi tiết bài viết ở Client
        function ChiTiet() {
            $id = $_GET['id'];
                include ROOT. '/Common/database.php'; 
        ...
        // - Hiển thị bài viết theo tag ở client
        function Tag () {
            $id = $_GET['id'];
                include ROOT. '/Common/database.php'; 
        ...
        // - Hiển thị tất cả bài viết ở client
        ...
        // - Danh sách Tin tức trên trang ADMIN
        function ListPosts()
        {
                // Hiển thị
                include ROOT. '/Common/database.php'; 
        ...
        // - Chuyển đổi trạng thái Tin tức trên trang ADMIN
        ...
        // - Chỉnh sửa bài viết trên trang ADMIN
        ...
        // - Hiển thị  danh sách các report NTD

<?php
    ...
    class JobController {
        // - Index() -> Quản lý các tin tuyển dụng ở trang NTD
        function Index()
        {
            if(!isset($_SESSION)) 
            { 
        ...
        // - ChiTiet() -> Xem chi tiết tin tuyển dụng ở Client
        function ChiTiet() {
            $id = $_GET['id'];
                include ROOT. '/Common/database.php'; 
        ...
        // - Create() -> Thêm mới tin tuyển dụng ở trang NTD
        function Create()
        {
            include ROOT. '/Common/database.php'; 
        ...
        // - RequestCreate() -> Thêm mới tin tuyển dụng ở trang NTD
        ...
        // - ListJobs() -> Hiển thị tất cả công việc ở trang XEM TẤT CẢ CÔNG VIỆC
        ...
        // - SavedJob() -> Ứng viên lưu công việc yêu thích
        function SavedJob () {
            $jobid = $_GET["job"];
            $userid = $_GET["uid"];
        ...
        //  - JobSearch() -> Tìm kiếm công việc theo từ khóa, ngành nghề, nơi làm việc
        function JobSearch () {
            if (isset($_POST)) {
                $q = $_POST['q'];
                $p = $_POST['p'];
        ...
        //  - JobSearchByCompany() -> Tìm kiếm công việc theo công ty
        ...
        //  - Career() -> Lọc công việc theo ngành nghề
        function Career () {
            $id = $_GET['id'];
                include ROOT. '/Common/database.php'; 
        ...
        // - CandidateApplySuccess() -> Nếu ứng tuyển thành công thì direct sang trang thông báo ứng tuyển thành công
        function CandidateApplySuccess()
        {
            require_once ROOT . '/Views/client/Job/success.php';
        }

        // - ListCandidateApply() -> Ứng Viên xem lại các đơn đã ứng tuyển ở Client

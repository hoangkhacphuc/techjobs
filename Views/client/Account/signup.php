			...
			<div class="w-login m-auto">
				<div class="login-logo">
					<h3>
						...
						<a href="./">
							<img src="Assets/client/img/logo1.png" alt="VNUA HR">
						</a>
					</h3>
			...
			<div class="w-login m-auto">
				<div class="row">
					...
					<div class="col-md-6 col-sm-12 col-12 login-main-right">
						...
						<form class="login-form reg-form" method="POST" action="?c=User&a=DangKy_User" id="registration">
						  ...
						  <div class="input-div one">
		           		...
		           		<div class="input-div one">
		           		   <div class="div lg-lable">
		           		   		...
		           		   		<input type="text" name="Phone" class="input form-control-lgin">
		           		   </div>
		           		</div>
		           		<div class="input-div one">
		           		   <div class="div lg-lable">
		            	...
		            	<div class="input-div one">
		           		   <div class="div lg-lable">
		           		    	...
		           		    	<input type="password" name="ConfirmPassword" id="ConfirmPassword" class="input form-control-lgin">
		            	   </div>
		            	</div>
						  <div class="form-group d-block frm-text">
						    <a href="#" class="fg-login d-inline-block"></a>
						    <a href="?c=User&a=DangNhapUser" class="fg-login float-right d-inline-block">Bạn đã có tài khoản? Đăng Nhập</a>
						  </div>
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-12 col-12 login-footer-left">
					<div class="login-copyright">
						<p>Copyright © 2020 <a href="#"> VNUA HR</a>. All Rights Reserved.</p>
					</div>
				</div>
				<!-- login footer right -->

<?php
      ...
      $query = "SELECT users.full_name, users.id, users.user_type FROM users WHERE email = '$user'";
...
<div class="container-fluid fluid-nav another-page" style="margin-bottom: 0px;">
  ...
  <a href="index.php" class="nav-logo">
    <img src="Assets/client/img/logo1.png">
  </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav mr-auto my-2 my-lg-0 tnav-right tn-nav">
      <?php if(isset($_SESSION['login_user'])){ ?>
        ...
        <?php 
          if ($data[0][2] == "2") { ?>
            <a class="dropdown-item" href="?c=Home&a=Recruitment">Quản lý chung</a>
            <a class="dropdown-item" href="?c=User&a=RecProfile&id=<?= $user_full_name[1] ?>">Thay đổi thông tin</a>
        <?php } ?>
        <?php 
          if ($data[0][2] == "3") { ?>
            <a class="dropdown-item" href="?c=Home&a=Admin">Quản lý chung</a>
            <a class="dropdown-item" href="?c=User&a=AdminProfile&id=<?= $user_full_name[1] ?>">Thay đổi thông tin</a>
        <?php } ?>
      ...
      <li class="nav-item">
        <a class="nav-link" href="?c=User&a=SignInAdmin">ADMIN</a>
      </li>
      <?php }  ?>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">

    ...
    <div class="container cnt-tnar">
      <nav class="navbar navbar-expand-lg navbar-light bg-light tjnav-bar">
        ...
        <a href="#" class="nav-logo">
          <span style="font-family: Rounded; font-size: 30px; font-weight: 600; color: #fff;">VNUA HR</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav mr-auto my-2 my-lg-0 tnav-right tn-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="./register-employees.php">Đăng Ký</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="./login-employees.php">Đăng Nhập</a>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                VI
            ...
            <li class="nav-item">
              <a class="nav-link btn-employers" href="./login-employers.php" tabindex="-1" aria-disabled="true">Nhà Tuyển Dụng</a>
            </li>
          </ul>
        </div>
      </nav>
  ...
  <footer class="container-fluid copyright-wrap">
    <div class="container copyright">
      <p class="copyright-content">
        Copyright © 2020 <a href="#"> Nguyễn Nam Khánh</a>. All Right Reserved.
      </p>
    </div>
  </footer>
